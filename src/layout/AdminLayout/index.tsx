...
import { FaBlog, FaBlogger, FaFileImage, FaComment } from 'react-icons/fa';
    ...
    <Layout style={{ minHeight: "100vh" }}>
      ...
      >
        ...
        <Menu className='!text-left' theme="dark" mode="inline" defaultSelectedKeys={["dashboard"]}>
          ...
          <Menu.Item onClick={() => navigate(RouteNames.STAFF_SCHEDULE_MANAGEMENT)} key="staff-schedule" icon={<CalendarOutlined />}>Staff Schedule</Menu.Item>
